...
public interface WaitListRepository extends CassandraRepository<WaitList, UUID> {
    ...
    @AllowFiltering
    List<WaitList> findAllByPatientIdAndShiftDateAndStatus(Integer patientId, String date, String status);
    ...
    @AllowFiltering
    List<WaitList> findAllByClinicIdAndShiftDateAndShiftIdAndChairIdAndStatus(
            Integer clinicId, String shiftDate, Integer shiftId, Integer chairId, String status);
}
